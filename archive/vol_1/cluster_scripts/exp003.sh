#!/bin/bash
#SBATCH --job-name=exp003
#SBATCH --partition=xlong
#SBATCH --gres=gpu:1
#SBATCH --time=48:00:00
#SBATCH --output=cluster_scripts/logs/exp003_%j.out
#SBATCH --error=cluster_scripts/logs/exp003_%j.err
...
mim train mmdet configs/raw_experiments/exp003.py --launcher none
