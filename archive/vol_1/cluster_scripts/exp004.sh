#!/bin/bash
#SBATCH --job-name=exp004
#SBATCH --partition=xlong
#SBATCH --gres=gpu:1
#SBATCH --time=48:00:00
#SBATCH --output=cluster_scripts/logs/exp004_%j.out
#SBATCH --error=cluster_scripts/logs/exp004_%j.err
...
mim train mmdet configs/raw_experiments/exp004.py --launcher none
