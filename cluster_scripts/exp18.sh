...
#SBATCH --output=/networkhome/WMGDS/souval_g/neuRAWns_mmdet/cluster_scripts/logs/exp18_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/neuRAWns_mmdet/cluster_scripts/logs/exp18_%j.err
...
mim train mmdet configs/experiments/exp18_pack4ch_learnable_curve.py \
    --launcher none \
    --work-dir /networkhome/WMGDS/souval_g/neuRAWns_mmdet/work_dirs/exp18 \
    --cfg-options \
