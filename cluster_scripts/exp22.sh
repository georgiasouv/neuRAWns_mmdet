...
#SBATCH --output=/networkhome/WMGDS/souval_g/neuRAWns_mmdet/cluster_scripts/logs/exp22_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/neuRAWns_mmdet/cluster_scripts/logs/exp22_%j.err
...
mim train mmdet configs/experiments/exp22_curve_lin.py \
    --launcher none \
    --work-dir /networkhome/WMGDS/souval_g/neuRAWns_mmdet/work_dirs/exp22_curve_lin \
    --cfg-options \
