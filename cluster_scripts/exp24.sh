...
#SBATCH --output=/networkhome/WMGDS/souval_g/neuRAWns_mmdet/cluster_scripts/logs/exp24_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/neuRAWns_mmdet/cluster_scripts/logs/exp24_%j.err
...
# ── Training ──────────────────────────────────────────────────
echo "=== Starting exp24_hybrid_lin ==="
...
mim train mmdet configs/experiments/exp24_hybrid_lin.py \
    --launcher none \
    --work-dir /networkhome/WMGDS/souval_g/neuRAWns_mmdet/work_dirs/exp24_hybrid_lin \
    --cfg-options \
...
echo "=== exp24_hybrid_lin finished ==="