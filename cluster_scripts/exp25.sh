...
#SBATCH --output=/networkhome/WMGDS/souval_g/neuRAWns_mmdet/cluster_scripts/logs/exp25_%j.out
#SBATCH --error=/networkhome/WMGDS/souval_g/neuRAWns_mmdet/cluster_scripts/logs/exp25_%j.err
...
# ── Training ──────────────────────────────────────────────────
echo "=== Starting exp25_hybrid_log ==="
...
mim train mmdet configs/experiments/exp25_hybrid_log.py \
    --launcher none \
    --work-dir /networkhome/WMGDS/souval_g/neuRAWns_mmdet/work_dirs/exp25_hybrid_log \
    --cfg-options \
...
echo "=== exp25_hybrid_log finished ==="