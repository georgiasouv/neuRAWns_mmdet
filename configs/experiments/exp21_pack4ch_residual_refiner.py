# ─────────────────────────────────────────────────────────────
# experiments/exp21_pack4ch_residual_refiner.py
# Input:        Packed 4ch (greens kept separate)
# Preprocessor: log-gamma backbone + depthwise-separable residual → 3×3 4→3
