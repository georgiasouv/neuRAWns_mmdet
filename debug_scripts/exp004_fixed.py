...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='json_sample_raw_coco/train.json',
        data_prefix=dict(img='sample_images/train'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='json_sample_raw_coco/val.json',
        data_prefix=dict(img='sample_images/val'),
